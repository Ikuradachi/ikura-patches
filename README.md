...
> **[v1.0.1-dev.2](https://github.com/Ikuradachi/ikura-patches/releases/tag/v1.0.1-dev.2)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;3 patches total
<details open>
...
| [Unlock premium features](#unlock-premium-features) | Unlocks Mapbox, Google Maps, Spotify, and TwinSpace premium features and displays the VIP settings item. |  |
